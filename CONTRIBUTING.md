...
The kit has no standalone dev server. To see components rendered, install it into a Django
project configured with the Tailwind v4 build (scan the component templates with `@source`,
import `cotton-ui.css`, load the Alpine bundle), exactly the setup in the
[installation guide](https://django-cotton.com/ui/installation). The documentation site at
[django-cotton.com/ui](https://django-cotton.com/ui) is the canonical example and where
components are developed against live.
